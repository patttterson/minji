<script lang="ts">
	...
	const badgeImages = import.meta.glob('$lib/assets/badges/*.{png,gif,jpg,webp}', {
		eager: true,
		import: 'default'
  ...
  function resolveBadgeSrc(src: string): string {
	...
	export let badges: Badge[] = [
		...
		{ id: 'newjeans', kind: 'image', src: 'newjeans.gif', alt: 'newjeans.gif', href: 'https://w.wiki/HpXe/' },
		{ id: 'patty', kind: 'image', src: 'patty.gif', alt: 'patty.gif', href: 'https://minji.love/' },
    ...
    { id: 'vgen', kind: 'image', src: 'vgen.png', alt: 'vgen.png', href: 'https://vgen.co/' },
		...
		{ id: 'vert', kind: 'image', src: 'vert.gif', alt: 'vert.gif', href: 'https://vert.minji.love/' },
		{ id: '2dollars-and-a-burger', kind: 'image', src: '2dollars-and-a-burger.png', alt: '2dollars-and-a-burger.png' },
